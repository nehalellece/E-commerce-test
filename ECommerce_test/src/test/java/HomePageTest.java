...
//        System.out.println(homePage.addToCartBtns().get(getRandomNumberInRange(0,itemArraySize)).getText());
    ...
    public void makeAnOrder() throws InterruptedException {
        ...
        Thread.sleep(1000);
        homePage.productAddMsgLink().click();
//        System.out.println(homePage.shoppingCartLink().getText());
//        homePage.shoppingCartLink().click();
        ...
        /*List<String> fieldToFill = null;
        fieldToFill.add(0,"Eyad");
        fieldToFill.add(1,"Alsayed");
        fieldToFill.add(2,"Eyad@mail.com");
        fieldToFill.add(3,"abc");
        fieldToFill.add(4,"egypt");
        fieldToFill.add(5,"Eyad");
        fieldToFill.add(6,"");
        fieldToFill.add(7,"cairo");
        fieldToFill.add(8,"asd");
        fieldToFill.add(9,"asd");
        fieldToFill.add(10,"23165");
        fieldToFill.add(11,"654654");
        fieldToFill.add(12,"84654");
        fieldToFill.add(13,"654654");*/
...
//        System.out.println(homePage.addToWishListBtn().get(getRandomNumberInRange(0,itemArraySize)).getText());
//////////////////////////////////////////
//        try{homePage.addToWishListBtn().get(getRandomNumberInRange(0,itemArraySize)).click();}
//        catch(Exception io){homePage.addToWishListBtn().get(getRandomNumberInRange(0,itemArraySize)).click();}
